...
data[[1]] <- readRDS(sprintf('Table/ELA_ProkFungi_%s/ELAstability_%s.rds', th, lv))
data[[2]] <- readRDS(sprintf('Table/ELA_Prok_%s/ELAstability_%s.rds', th, lv))
data[[3]] <- readRDS(sprintf('Table/ELA_Fungi_%s/ELAstability_%s.rds', th, lv))
...
data[[1]] <- readRDS(sprintf('Table/ELA_ProkFungi_%s/ELAstability_%s.rds', th, lv))
data[[2]] <- readRDS(sprintf('Table/ELA_Prok_%s/ELAstability_%s.rds', th, lv))
data[[3]] <- readRDS(sprintf('Table/ELA_Fungi_%s/ELAstability_%s.rds', th, lv))[,c(1,2,3,5,4)]
