...
write.table(cbind(Sample.ID=rownames(smlout), smlout), file=sprintf('%s/SampleInfo_RmOutliers_envpca.txt', dir$tabledir), quote=F, sep='\t', row.names=F)

saveRDS(smlout, 'Table/0301_sml_envpca.rds')
