...
summary(lme4::glmer(DL.bin~ PCoA1 + PCoA2 + PCoA3 + PCoA4 + PCoA5 + (1| rand), family = binomial,  data= dfbac))

summary(lme4::glmer(DL.bin~ PCoA1 + PCoA2 + PCoA3 + PCoA4 + PCoA5 + (1| rand), family = binomial,  data= dffng))
