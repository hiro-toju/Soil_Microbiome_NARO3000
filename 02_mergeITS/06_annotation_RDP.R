...
refference <- "Table/sh_general_release_dynamic_s_all_25.07.2023.fasta"
...
## -- Load data tables
seqfasta <- read.fasta("Table/04_OTUseq_0.97.fasta")
seqvec <- sapply(seqfasta, paste, collapse="")
## ===================================================== ##
# -- Assign taxonomy
s <- Sys.time()
taxa <- assignTaxonomy(seqvec, refference, multithread=TRUE)
