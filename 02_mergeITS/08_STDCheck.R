...
#### 2022. 3. 16 Fujita
#### R 4.1.2
#### setwd("~/Desktop/NARO/220316/02_mergeITS")
#### 
############################################################################
...
seqtab <- as.data.frame(readRDS("Table/04_seqOTUtab_0.97.rds"))

# -- Nnumber of copies of standard DNA
std.copy.n <- c(  0.5,0.35,0.25,0.10, 0.05  )*(6.02*10^13/1000000)/50000
